...
angular.module('teacher.questionLibrary.detail', [
  ...
  .config(function ($stateProvider) {
    $stateProvider.state('teacher.questionLibraryDetail', {
  ...
  .factory('TeacherQuestionLibraryDetail', function ($http, Account, TeacherConstants, TeacherQuestionLibraryConstants) {
    var self = {};
    /**
  ...
  .controller('teacherQuestionLibraryDetailCtrl', function ($scope, TeacherQuestionLibrary, TeacherQuestionLibraryDetail) {
